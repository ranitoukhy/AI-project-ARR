...
if __name__ == '__main__':
    outfile = "C:\\Users\\alonl\\Documents\\GitHub\\AI-final-2\\res100WithStartCount.txt"
    ...
    for pop_size in population_sizes:
        for num_iter in number_iterations:
            for elit_frac in elitism_fractions:
                for cross_prob in cross_probs:
                    for mut_prob in mutation_probs:
                        for inner_mut_prob in inner_mutation_probs:
                            for start_count in start_item_counts:
                                ...
                                agent = genetic.GeneticAlgorithmAgent(
                                    ...
                                    cross_prob,
                                    mut_prob,
                                    inner_mutation_prob=inner_mut_prob,
